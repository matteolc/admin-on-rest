...
var Login = function (_Component) {
    ...
    function Login() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref2 = Login.__proto__ || Object.getPrototypeOf(Login)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {
            submitting: false
        }, _this.login = function (auth) {
            _this.setState({ submitting: true });
            _this.props.userLogin(auth, _this.props.location.state ? _this.props.location.state.nextPathname : '/');
