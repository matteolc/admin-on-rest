    ...
    function SaveButton() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = SaveButton.__proto__ || Object.getPrototypeOf(SaveButton)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (e) {
            if (_this.props.saving) {
                ...
                e.preventDefault();
            } else if (!_this.props.submitOnEnter) {
...
var mapDispatchToProps = { submit: function submit() {
        return (0, _reduxForm.submit)('record-form');
    } };

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)((0, _translate2.default)(SaveButton));