...
var Datagrid = function (_Component) {
    ...
    (0, _createClass3.default)(Datagrid, [{
        ...
        value: function render() {
            ...
            var multiSelectable = options && options.multiSelectable || false;
            return _react2.default.createElement(
                _Table.Table,
                (0, _extends3.default)({ style: options && options.fixedHeader ? null : styles.table, fixedHeader: false, onRowSelection: this.onRowSelection, enableSelectAll: multiSelectable }, options),
                _react2.default.createElement(
                    _Table.TableHeader,
                    (0, _extends3.default)({ displaySelectAll: multiSelectable, adjustForCheckbox: multiSelectable }, headerOptions),
                    _react2.default.createElement(
                        _Table.TableRow,
