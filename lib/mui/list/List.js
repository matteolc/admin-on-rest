...
var List = exports.List = function (_Component) {
    ...
    function List(props) {
        ...
        _this.handleRowSelection = function (selectedRows) {
            return _this.setState({ selectedRows: selectedRows });
        };
        ...
        _this.state = { key: 0, selectedRows: [] };
        return _this;
    }
    ...
    (0, _createClass3.default)(List, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                hasDownload = _props.hasDownload,
                title = _props.title,
                data = _props.data,
                ids = _props.ids,
                total = _props.total,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    aggregations && reports && _react2.default.cloneElement(reports, { aggregations: aggregations }),
...
List.propTypes = {
    ...
    hasDelete: _propTypes2.default.bool.isRequired,
    hasDownload: _propTypes2.default.bool.isRequired,
