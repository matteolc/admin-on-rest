...
class Datagrid extends Component {
    ...
    onRowSelection = (selectedRows) => {
    	const { handleRowSelection, ids } = this.props;
        switch (selectedRows) {
          case "all": 
          	  return handleRowSelection(ids);
          case "none": 
          	  return handleRowSelection([]);
          default: 
          	  return handleRowSelection(_.at(ids, selectedRows));
        }
    }    
    ...
    render() {
        ...
        const multiSelectable = options && options.multiSelectable || false
        return (
            <Table style={options && options.fixedHeader ? null : styles.table} fixedHeader={false} onRowSelection={this.onRowSelection} enableSelectAll={multiSelectable} {...options}>
                <TableHeader displaySelectAll={multiSelectable} adjustForCheckbox={multiSelectable} {...headerOptions}>
