...
export class List extends Component {
    ...
    handleRowSelection = selectedRows => this.setState({selectedRows: selectedRows});  
    ...
    render() {
        const { filters, pagination = <DefaultPagination />, actions = <DefaultActions />, resource, hasCreate, hasDelete, hasDownload, title, data, ids, total, children, isLoading, translate, aggregations, reports } = this.props;
        ...
        return (
            <div className="list-page">
                <Card style={{ opacity: isLoading ? 0.8 : 1 }}>
                    ...
                    {aggregations && reports && React.cloneElement(reports, { aggregations })} 
                    { isLoading || total > 0 ?
                        <div key={key}>
...
function mapStateToProps(state, props) {
    ...
    return {
        ...
        aggregations: resourceState.aggregations,
